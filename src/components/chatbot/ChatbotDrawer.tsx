        ...
        <div className="flex items-center justify-between bg-linear-to-r from-[#0d7a6a] to-[#0a6458] px-4 py-3 rounded-t-2xl">
          ...
          <div className="flex items-center gap-0.5">
            <button
              ...
              className="rounded-lg p-1.5 text-white/70 transition-colors hover:bg-white/10 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/80"
              aria-label={isMinimized ? 'Buka panel chatbot' : 'Minimalkan panel chatbot'}
            ...
            <button
              ...
              className={cn(
                'rounded-lg p-1.5 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/80',
                showLocation && lat
                  ? 'bg-white/15 text-white'
                  : 'text-white/70 hover:bg-white/10 hover:text-white',
                locationLoading && 'opacity-50 cursor-not-allowed'
              )}
              aria-label="Aktifkan lokasi untuk rekomendasi terdekat"
            ...
            <button
              ...
              className="rounded-lg p-1.5 text-white/70 transition-colors hover:bg-white/10 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/80"
              aria-label="Buat sesi chatbot baru"
            ...
            {showLocation && (
              <div className="flex items-center justify-between bg-slate-50 px-4 py-2 text-xs border-b border-slate-100">
                ...
                <button
                  ...
                  className="text-slate-400 transition-colors hover:text-slate-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-citra-focus"
                  aria-label="Matikan lokasi dari chatbot"
                >
                  ...
                  <div className="flex flex-col gap-2 w-full max-w-70">
                    {[
                      ...
                      <button
                        ...
                        className="w-full flex items-center gap-2 text-left rounded-xl bg-slate-50 hover:bg-citra-primary-soft px-4 py-2.5 text-xs font-medium text-slate-600 transition-all hover:text-citra-primary border border-slate-200 hover:border-citra-primary/40 shadow-xs hover:shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-citra-focus"
                      >
                        {item.icon}
            ...
            <div className="bg-white rounded-xl p-5 shadow-xl w-[85%] max-w-sm text-center">
              ...
              <div className="flex gap-3 justify-center">
                <button
                  ...
                  className="px-4 py-2 rounded-lg text-sm font-medium text-slate-600 hover:bg-slate-100 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-citra-focus"
                >
                  Batal
                </button>
                <button
                  ...
                  className="px-4 py-2 rounded-lg text-sm font-medium bg-red-500 text-white hover:bg-red-600 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-600 focus-visible:ring-offset-2"
                >
                  Ya, Mulai Baru
                </button>
              </div>
