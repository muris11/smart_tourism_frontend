  ...
  if (!item) {
    return (
      <NotFoundState
        ...
        description="Kuliner yang kamu cari tidak tersedia atau telah dihapus."
        actionLabel="Jelajahi Kuliner Lain"
        actionHref="/kuliner"
      />
    )
  }
  ...
  return (
    <div>
      ...
      <div className="mx-auto max-w-6xl px-4 py-8 md:px-6 md:py-10 lg:py-12">
        ...
        <RekomendasiLain items={rekomendasi} basePath="kuliner" label="Kuliner" />
      </div>
    </div>
  )
}
